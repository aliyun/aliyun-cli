...
//
// CLI version is stamped first. cliVersion is the embedding CLI version
// (e.g. cli.GetVersion()); empty omits the Aliyun-CLI segment.
...
// ComposeUserAgent joins the base prefix with host-supplied suffixes
// (--user-agent, AI-mode segments). Empty suffix yields the base alone.
