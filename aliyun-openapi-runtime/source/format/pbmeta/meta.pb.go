...
func (x *Operation) GetSignatureAlgorithm() string {
	if x != nil {
...
const file_aliyun_openapi_meta_proto_rawDesc = "" +
	"\n" +
	"\x19aliyun_openapi_meta.proto\x12\x16aliyun.openapi.meta.v1\"\xbf\x04\n" +
	...
	"parameters\x12\x1c\n" +
	"\tresponses\x18\x0e \x01(\fR\tresponses\x12\x1e\n" +
	"\n" +
	"components\x18\x0f \x01(\fR\n" +
	"components\"\xe2\x02\n" +
	"\tOperation\x12\x16\n" +
	...
	" \x01(\bR\x0fhasWildcardPath\x12/\n" +
	"\x13signature_algorithm\x18\v \x01(\tR\x12signatureAlgorithm\"\xd9\x05\n" +
	"\bArgument\x12\x12\n" +
